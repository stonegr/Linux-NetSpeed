...
```
原版
wget --no-check-certificate "https://raw.githubusercontent.com/stonegr/wdjs/master/tcp0.sh" && chmod +x tcp0.sh && ./tcp0.sh
不卸载内核：
wget --no-check-certificate "https://raw.githubusercontent.com/ylx2016/Linux-NetSpeed/master/tcpx.sh" && chmod +x tcpx.sh && ./tcpx.sh
卸载内核：
wget --no-check-certificate "https://raw.githubusercontent.com//ylx2016/Linux-NetSpeed/master/tcp.sh" && chmod +x tcp.sh && ./tcp.sh
