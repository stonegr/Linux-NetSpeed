...
installbbrplusnew() {
    ...
    if [[ "${release}" == "centos" ]]; then
        ...
        if [[ ${bit} == "x86_64" ]]; then
            ...
            # wget -N -O linux-headers-d10.deb $headurl
            # wget -N -O linux-image-d10.deb $imgurl
            # headurl='https://github.com/UJX6N/bbrplus-5.10/releases/download/5.10.79-bbrplus/Debian-Ubuntu_Required_linux-headers-5.10.79-bbrplus_5.10.79-bbrplus-1_amd64.deb'
